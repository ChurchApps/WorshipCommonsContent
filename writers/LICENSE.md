# Writers — portraits and bios

- `portrait.jpg` files are Wikimedia-Commons-verified **public domain / CC0**
  portraits of catalog hymn writers.
- The `bio` text in each `writer.json` is the opening of the writer's Wikipedia
